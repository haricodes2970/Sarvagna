...
import { Flame, Plus, BookOpen, AlertCircle, CheckCircle2, Database, FileSearch, Map, Brain, TrendingUp } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            ...
            <button
              ...
              className="hidden md:flex items-center gap-2 text-slate-400 hover:text-teal-400 transition-colors text-sm font-bold"
            >
